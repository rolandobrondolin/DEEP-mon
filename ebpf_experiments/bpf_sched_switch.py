...
bpf_tracer = BPF(src_file="bpf_sched_switch.c", cflags=["-DNUM_CPUS=%d" % multiprocessing.cpu_count(), "-DFILTER_PID=%d" % os.getpid()])
bpf_tracer.attach_tracepoint(tp="sched:sched_switch", fn_name="trace_function")
bpf_tracer["cpu_cycles"].open_perf_event(PerfType.HARDWARE, PerfHWConfig.CPU_CYCLES)
