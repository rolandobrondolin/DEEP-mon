...
def deepmon(kube_config, window_mode, output_format, debug_mode, net_monitor, nat_trace):
    monitor = MonitorMain(output_format, window_mode, debug_mode, net_monitor, nat_trace)
